            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_usecase.CompanyLearningSummaryOutput"
                        }
                    },
                    "401": {
                        "description": "未認証",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_usecase.CourseWithProgress"
                            }
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "UP",
                        "schema": {
                            "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_domain.Health"
                        }
                    },
                    "503": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbVerifyShareLinkRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbVerifiedShareLinkResponse"
                        }
                    },
                    "400": {
                        "description": "バリデーション エラー",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbGrantRoleRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbWorkspaceGrantResponse"
                        }
                    },
                    "400": {
                        "description": "バリデーション エラー",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbCreateGroupRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbPrincipalResponse"
                        }
                    },
                    "400": {
                        "description": "バリデーション エラー",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbSetRestrictionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbPageRestrictionResponse"
                        }
                    },
                    "400": {
                        "description": "バリデーション エラー",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_handler.kbShareLinkResponse"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbIssueShareLinkRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbIssuedShareLinkResponse"
                        }
                    },
                    "400": {
                        "description": "バリデーション エラー",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.kbSpaceGrantResponse"
                        }
                    },
                    "400": {
                        "description": "バリデーション エラー",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_domain.UserLessonProgress"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.markLessonCompleteRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_usecase.GetUserDashboardOutput"
                        }
                    },
                    "401": {
                        "description": "未認証",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_domain.Note"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.noteCreateReq"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.noteUpdateReq"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_domain.Notification"
                            }
                        }
                    },
                    "400": {
        ...
        "github_com_norman6464_FreStyle_backend_internal_usecase.GetUserDashboardOutput": {
            ...
            "properties": {
                "recentActivity": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_norman6464_FreStyle_backend_internal_domain.UserDailyActivity"
                    }
                },
                "recentChapterViews": {
                    "type": "array",

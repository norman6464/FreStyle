...
type UserLessonProgress struct {
	...
	TeachingMaterialID uint64    `gorm:"column:chapter_id;not null;uniqueIndex:ux_user_chapter_progress" json:"teachingMaterialId"`
...
func (UserLessonProgress) TableName() string { return "user_chapter_progress" }

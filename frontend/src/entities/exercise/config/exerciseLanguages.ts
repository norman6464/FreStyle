...
export const EXERCISE_LANGUAGES: ExerciseLanguageDef[] = [
  ...
  { key: 'ruby', label: 'Ruby', badgeClass: LANGUAGE_BADGE_CLASSES.ruby },
  { key: 'cpp', label: 'C++', badgeClass: LANGUAGE_BADGE_CLASSES.cpp },
  { key: 'c', label: 'C', badgeClass: LANGUAGE_BADGE_CLASSES.c },

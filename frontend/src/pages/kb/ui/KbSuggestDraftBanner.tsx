...
export default function KbSuggestDraftBanner({
  ...
  return (
    <div
      role="status"
      className="mb-4 flex flex-col gap-2 rounded-lg border border-l-4 border-surface-3 border-l-amber-400 bg-amber-500/10 px-3 py-2.5"
    >
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2 text-sm text-[var(--color-text-secondary)]">
          <PencilSquareIcon className="h-4 w-4 shrink-0 text-amber-600" aria-hidden="true" />

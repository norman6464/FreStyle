...
export const EDITOR_COMMANDS: EditorCommand[] = [
  ...
  // --- ブロックの種類変換（turn into） ---
  {
    ...
    group: 'turn',
    glyph: 'H1',
    keywords: ['h1', '見出し', 'heading', 'midashi'],
  ...
  },
  {
    ...
    group: 'turn',
    glyph: 'H2',
    keywords: ['h2', '見出し', 'heading', 'midashi'],
  ...
  },
  {
    ...
    group: 'turn',
    glyph: 'H3',
    keywords: ['h3', '見出し', 'heading', 'midashi'],
  ...
  },
  {
    ...
    group: 'turn',
    glyph: '“',
    keywords: ['quote', '引用', 'いんよう', 'blockquote'],
  ...
  },
  {
    ...
    group: 'turn',
    glyph: '{ }',
    keywords: ['codeblock', 'コードブロック', 'pre'],
